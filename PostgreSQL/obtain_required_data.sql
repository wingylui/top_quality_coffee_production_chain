...
SELECT COFFEE.coffee_ID, COFFEE.coffee_name, COFFEE.agtron_WB, R.roast_level, COFFEE.price_per_kg_USD
...
SELECT COFFEE.coffee_ID, COFFEE.coffee_name, S.species_name, COUNTRY.country_name AS origin_country_name
...
SELECT COFFEE.coffee_ID, COFFEE.coffee_name, R.raoster_name AS roaster_name, CITY.roaster_city,
